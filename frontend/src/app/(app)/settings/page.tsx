      ...
      <div className="glass-card mb-6 overflow-hidden">
        <div className="p-6 border-b border-slate-200 dark:border-white/[0.06]">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-slate-900 dark:text-zinc-100">Kalender-integration</h2>
          </div>
          <p className="text-sm text-slate-500 dark:text-zinc-500 mt-1">
            Synkronisér aftaler og opgaver med din Google- eller Outlook-kalender automatisk.
          </p>
        </div>

        <div className="p-6">
          {calendarStatus?.connected ? (
            <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-500/10 rounded-lg border border-green-200 dark:border-green-500/20 mb-4">
              <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" />
              <div>
                <p className="text-sm font-medium text-green-800 dark:text-green-300">
                  Forbundet med {calendarStatus.provider === 'gmail' ? 'Google Kalender' : 'Outlook Kalender'}
                </p>
                <p className="text-xs text-green-600 dark:text-green-400">{calendarStatus.email}</p>
              </div>
            </div>
          ) : (
            <p className="text-sm text-slate-500 dark:text-zinc-500 mb-4">
              Forbind en mailkonto herunder for at aktivere kalender-synkronisering. Kalender-adgang kræver ny godkendelse.
            </p>
          )}
